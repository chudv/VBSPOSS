...
namespace VBSPOSS.Services.Interfaces
{
    public interface IUserManagementIDCService
    {
        ...
        /// </returns>
        /// <exception cref="Exception"></exception>
        Task<PendingTransAPIResponseViewModel> GetPendingTransactionsByApiPendingTxn(PendingTransRequestViewModel requestInput, string pApiName, string pUserNameUpd);
