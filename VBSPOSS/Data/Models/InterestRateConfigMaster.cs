...
namespace VBSPOSS.Data.Models
{
    ...
    public class InterestRateConfigMasterView
    {
        ...
        public string StatusDesc
        {
            get
            {
                return ConfigStatus.GetByValue(Status)?.Description ?? "Không xác định";
            }
        }
        ...
        public string ListPosCode { get; set; }

        public string ListPosName { get; set; }
