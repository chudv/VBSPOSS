...
{
    public class TransferDataPosController1 : BaseController
    {
        ...
        public TransferDataPosController1(ILogger<UserManagementIDCController> logger, IAdministrationService adminService, ISessionHelper sessionHelper,
