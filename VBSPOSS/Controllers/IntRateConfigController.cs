        ...
        public async Task<IActionResult> SaveTidePenalRateConfig()
        {
            ...
            try
            {
                ...
                foreach (var itemData in requestUpd.ListItemUpdates)
                {
                    ...
                    itemUpdAdd.UserId = _serviceLOV.GetCellValueForQuery($"Select IsNull(Notes,'') From ListOfValue Where Code='UserIdCallAPIIDC' And ParentId={ListOfValueParentValue.ParentIdConfigIntellectIDC}");// ConstValueAPI.UserId_Call_ApiIDC;
