...
namespace VBSPOSS.ViewModels
{
    public class UserManagementIDCViewModel
    {
        ...
        public string UserStatusText { get; set; }      //Thêm
        ...
        /// <summary>
        /// Có quyền tiền mặt là "Y", Không có là "N"
        /// </summary>
        ...
        /// <summary>
        /// Nếu có quyền tiền mặt là "X", Không có để trống
        /// </summary>
        public string RoleToTransferCashName { get; set; }
        public DateTime StartDate { get; set; }
        public string StartDateText { get; set; }         //Thêm
        ...
        public string CallApiAutoGeneratedPassword { get; set; }
        public string PosCodeOld { get; set; }
        public string PosNameOld { get; set; }
        public string GroupNameOld { get; set; }
        public string GroupNameOldText { get; set; }       //Thêm
        public string FirstNameOld { get; set; }
        public string LastNameOld { get; set; }
        public string FullNameOld { get; set; }
        public string EmailAddressOld { get; set; }
        public string MobileNumberOld { get; set; }
        public DateTime DateOfBirthOld { get; set; }
        /// <summary>
        /// Có quyền tiền mặt là "Y", Không có là "N"
        /// </summary>
        public string RoleToTransferCashValueOld { get; set; }
        /// <summary>
        /// Nếu có quyền tiền mặt là "X", Không có để trống
        /// </summary>
        public string RoleToTransferCashNameOld { get; set; }
        /// <summary>
        /// "Có quyền tiền mặt" hoặc "Không có quyền tiền mặt";
        /// </summary>
        public string RoleToTransferCashDescriptionOld { get; set; }
        ...
        /// <summary>
        /// 1 - Tồn tại trong Core; 0 - Không tồn tại trong Core
        /// </summary>
        public int ExistsInCore { get; set; }
        ...
        public string PosCodeNewWhenChangePos { get; set; }
        public string GroupNameNewWhenChangePos { get; set; }
    ...
    /// </summary>
    public class UserManagementIDCSumRequirementViewModel
    {
    ...
    public class UserIDCMasterViewModel
    {
        ...
        public string UserType { get; set; }
        public string MailIdFlag { get; set; }
        public string MailIdFlagName { get; set; }      //Thêm
        public string AuthsecType { get; set; }
        public string AuthsecTypeName { get; set; }     //Thêm
        public string ExtraAttributeUserRole { get; set; }
        public string ExtraAttributeBranchCode { get; set; }
        public DateTime EffectiveDate { get; set; }
        public DateTime ExpiryDate { get; set; }
    ...
    public class Xoa_UserIDCApprovalViewModel
    {
        ...
        public int SoLgTrinh_Delete { get; set; }
